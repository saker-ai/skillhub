...
import { getSkill, getVersions, getFile, skillDownloadURL, type Skill, type SkillVersion } from '@saker/skillhub-client/skills';
import { ApiError } from '@saker/skillhub-client/client';
