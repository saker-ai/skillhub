...
import { getSkill, getVersions, publishSkillWithProgress } from '@saker/skillhub-client/skills';
import { listMyNamespaces, type Namespace } from '@saker/skillhub-client/namespaces';
import { SKILLHUB_PUBLISH_CURL_TEMPLATE, SKILLHUB_API_ENDPOINTS } from '@saker/skillhub-client/docs';
import CodeBlock from '../components/CodeBlock';
import { appAbsoluteURL, appBasePath } from '@saker/web-shared/base-path';
...
export default function Publish() {
  ...
  const baseURL = appAbsoluteURL(appBasePath(import.meta.env.BASE_URL), '');
        ...
        {tab === 'cli' && (
          <div>
            ...
            <div className="card" style={{ marginBottom: 24 }}>
              ...
              <CodeBlock command={SKILLHUB_PUBLISH_CURL_TEMPLATE(baseURL)} />
            </div>
            ...
            <div className="card">
              ...
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
                  ...
                  <tbody>
                    {SKILLHUB_API_ENDPOINTS.map(([endpoint, method, descKey]) => (
                      <tr key={endpoint} style={{ borderBottom: '1px solid var(--card-border)' }}>
                        ...
                        <td style={{ padding: '8px 12px', color: 'var(--text-secondary)' }}>{t(descKey)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
